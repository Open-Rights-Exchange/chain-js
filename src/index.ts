...
import * as ModelsAlgorand from './chains/algorand_1/models/indexToExport'
import * as ModelsEos from './chains/eos_2/models/indexToExport'
import * as ModelsEthereum from './chains/ethereum_1/models/indexToExport'
