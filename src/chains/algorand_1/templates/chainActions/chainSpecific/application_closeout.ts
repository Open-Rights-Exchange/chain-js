...
export const composeAction = (args: AlgorandActionAppMultiPurpose, suggestedParams: AlgorandSuggestedParams) => {
...
export const decomposeAction = (action: AlgorandTxAction | AlgorandTxActionRaw): AlgorandDecomposeReturn => {
  ...
  if (
    ...
    actionParams?.appOnComplete === AlgorandOnApplicationComplete.CloseOut
  ) {
    const returnData = {
      ...actionParams,
    }
